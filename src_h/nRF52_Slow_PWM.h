...
class NRF52TimerInterrupt
{
  ...
  public:
    ...
    bool setFrequency(float frequency, timerCallback callback)
    {
      ...
      {
        PWM_LOGERROR1(F("NRF52TimerInterrupt: ERROR: Negative or Too high frequency. Must be <="), _frequency/10.0f);
      ...
      PWM_LOGWARN3(F("NRF52TimerInterrupt: F_CPU (MHz) ="), F_CPU/1000000, F(", Timer = "), NRF52TimerName[_timer]);
